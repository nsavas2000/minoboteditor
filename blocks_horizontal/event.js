  ...
  init: function() {
    this.jsonInit({
      ...
      "args0": [
        {
          "type": "field_image",
          "src": Blockly.mainWorkspace.options.pathToMedia + "icons/runcode.png",
          "width": 40,
          "height": 40,
          "alt": "When green flag clicked",
          "flip_rtl": true
  ...
  init: function() {
    this.jsonInit({
      ...
      "args0": [
        {
          "type": "field_image",
          "src": Blockly.mainWorkspace.options.pathToMedia + "icons/fn.png",
          "width": 40,
          "height": 40,
          "alt": "When green flag clicked",
          "flip_rtl": true
      ...
      "colour": Blockly.Colours.event.primary,
      "colour": "#493D9E", 
      "colourSecondary": "#493D9E",
      "colourTertiary": "#493D9E"
    });
  }
};

Blockly.Blocks['call_fn'] = {
  /**
